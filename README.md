...
<a href="https://www.npmjs.com/package/fca-sus"><img alt="npm version" src="https://img.shields.io/npm/v/fca-sus.svg?style=flat-square"></a>
<img alt="version" src="https://img.shields.io/github/package-json/v/amogusdevlol/fca-sus?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/fca-sus"><img src="https://img.shields.io/npm/dm/fca-sus.svg?style=flat-square" alt="npm downloads"></a>
...
## Install
If you just want to use fca-sus, you should use this command:
```bash
npm install fca-sus
```
It will download `fca-sus` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install amogusdevlol/fca-sus
```
